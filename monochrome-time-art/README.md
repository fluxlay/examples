...
A minimal, artful black-and-white clock. The time is stacked colon-less (hours over minutes); every minute it re-renders through a different animation — flip, slide, dissolve, blur, glitch, fall, scale — and (in shuffle mode) a different Google Font, so the gesture never repeats. Theme (dark/light), 12/24-hour format, and an optional seconds readout are all configurable.
