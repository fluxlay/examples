...
const LAYERS: WaveLayer[] = [
  ...
  { baseAmplitude: 50, frequency: 1.0, speed: 0.4, phaseOffset: 1.2, yOffset: 0.7, opacity: 0.35 },
  { baseAmplitude: 45, frequency: 1.3, speed: 0.5, phaseOffset: 2.5, yOffset: 0.75, opacity: 0.4 },
  { baseAmplitude: 35, frequency: 1.6, speed: 0.6, phaseOffset: 3.8, yOffset: 0.8, opacity: 0.45 },
    ...
    const animate = () => {
      ...
      for (let li = 0; li < LAYERS.length; li++) {
        ...
        for (let x = 0; x <= w; x += 2) {
          ...
          const wave2 =
            Math.sin(nx * Math.PI * 2 * freq * 1.5 + t * layer.speed * 0.7 + layer.phaseOffset * 1.3) * amplitude * 0.3;
